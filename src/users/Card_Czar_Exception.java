...
/**
 * The exception that is thrown when an unnecessary Card Czar operation is performed on a player.
 * @version CAH1.0
 * @since CAH1.0
 * @author Holt Maki
...
public class Card_Czar_Exception extends Exception{
	 ...
	 * Card_Czar_Exception
	 */
	private static final long serialVersionUID = 7529123874109307999L;
